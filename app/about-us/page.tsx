  ...
  return (
    <div>
      ...
      <div className="max-w-5xl mx-auto px-6 md:px-12 lg:px-20 py-16">
        <h1 className="text-4xl font-bold text-[#5C66F0] mb-6">
          About ByteBazaar
        </h1>
        <p className="text-lg text-gray-700 leading-relaxed mb-8">
          Welcome to <span className="font-semibold">ByteBazaar</span> — a
        ...
        <div className="grid md:grid-cols-2 gap-12 mt-12">
          {/* Mission */}
          <div>
            <h2 className="text-2xl font-semibold text-[#5C66F0] mb-4">
              Our Mission
            </h2>
            <p className="text-gray-700 leading-relaxed">
              At ByteBazaar, our mission is simple: to make online shopping
          ...
          <div>
            ...
            <p className="text-gray-700 leading-relaxed">
              ...
              ByteBazaar is more than a store — it’s a community of shoppers who
        ...
        {/* Values */}
        <div className="mt-16">
          <h2 className="text-2xl font-semibold text-[#5C66F0] mb-6">
            Our Core Values
          </h2>
          <ul className="space-y-4 text-gray-700">
            ...
            <li>
              ✅{" "}
              <span className="font-medium text-[#5C66F0]">Innovation</span> –
        ...
        <div className="mt-20 text-center">
          <h2 className="text-3xl font-bold text-[#5C66F0] mb-4">
            Join the ByteBazaar Experience
          </h2>
          <p className="text-lg text-gray-700 mb-8">
            From your first click to the final checkout, ByteBazaar is here to
            make shopping smarter, faster, and better. Explore our collections
            today and discover why thousands of customers trust us.
          </p>
          <a
            href="/all-products"
            className="inline-block bg-[#5C66F0] text-white px-6 py-3 rounded-xl shadow-md hover:bg-[#4b54d1] transition"
          >
            Start Shopping
          </a>
        </div>
