...
const Product = () => {
  ...
  return productData ? (
    <>
      ...
      {/* MAIN CONTENT */}
      <div className="px-6 md:px-16 lg:px-32 pt-16 space-y-14">
            ...
            <div className="grid grid-cols-4 gap-4">
              {productData.image.map((image, index) => (
                <div
                  ...
                  className={`cursor-pointer rounded-lg overflow-hidden bg-gray-50 border ${
                    mainImage === image
                      ? "border-[#5F65F0]"
                      : "border-transparent"
                  } hover:border-[#5F65F0]/60 transition`}
                >
                  <Image
                    src={image}
          ...
          <div className="flex flex-col">
            ...
            <div className="flex items-center gap-4 mt-10">
              <button
                ...
                className="w-full py-3.5 bg-gray-100 text-gray-800 font-medium rounded-full border hover:bg-gray-200 transition"
              >
                Add to Cart
              </button>
              <button
                ...
                className="w-full py-3.5 bg-[#5F65F0] text-white font-medium rounded-full shadow hover:bg-[#4c52d1] transition"
              >
                Buy Now
              </button>
            </div>
        ...
        <div className="flex flex-col items-center">
          <div className="flex flex-col items-center mb-6">
            ...
            <div className="w-24 h-1 bg-[#5F65F0] mt-2 rounded-full"></div>
          </div>
          ...
          <button className="px-8 py-2 mb-16 border border-gray-300 rounded-full text-gray-600 hover:bg-gray-100 transition">
            See More
          </button>
        </div>
      </div>
